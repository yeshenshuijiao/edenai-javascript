...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EdenAiApiDocumentation.InlineResponse2003ResultBoundingBoxes = factory(root.EdenAiApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2003ResultBoundingBoxes model module.
   * @module edenai/model/InlineResponse2003ResultBoundingBoxes
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2003ResultBoundingBoxes</code>.
   * @alias module:edenai/model/InlineResponse2003ResultBoundingBoxes
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2003ResultBoundingBoxes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:edenai/model/InlineResponse2003ResultBoundingBoxes} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2003ResultBoundingBoxes} The populated <code>InlineResponse2003ResultBoundingBoxes</code> instance.
   */
   ...
   * @member {Number} hight
   */
  exports.prototype.hight = undefined;
