...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse2002Results'], factory);
    ...
    root.EdenAiApiDocumentation.InlineResponse2002 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse2002Results);
  }
   ...
   * @module edenai/model/InlineResponse2002
   * @version v1
   */
   ...
   * object
   * @alias module:edenai/model/InlineResponse2002
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse2002} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2002} The populated <code>InlineResponse2002</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('audio_name'))
        obj.audioName = ApiClient.convertToType(data['audio_name'], 'String');
  ...
  /**
   * @member {String} audioName
   */
  exports.prototype.audioName = undefined;

  /**
   * @member {Array.<module:edenai/model/InlineResponse2002Results>} results
   */
