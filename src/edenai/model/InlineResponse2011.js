...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse2011Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2011Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.EdenAiApiDocumentation) {
      root.EdenAiApiDocumentation = {};
    }
    root.EdenAiApiDocumentation.InlineResponse2011 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse2011Result1);
  }
}(this, function(ApiClient, InlineResponse2011Result1) {
  'use strict';

  /**
   * The InlineResponse2011 model module.
   * @module edenai/model/InlineResponse2011
   * @version v1
   */
   ...
   * @alias module:edenai/model/InlineResponse2011
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse2011} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2011} The populated <code>InlineResponse2011</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse2011Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:edenai/model/InlineResponse2011Result1>} result
   */
