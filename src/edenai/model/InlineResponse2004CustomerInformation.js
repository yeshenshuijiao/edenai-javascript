...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EdenAiApiDocumentation.InlineResponse2004CustomerInformation = factory(root.EdenAiApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2004CustomerInformation model module.
   * @module edenai/model/InlineResponse2004CustomerInformation
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2004CustomerInformation</code>.
   * @alias module:edenai/model/InlineResponse2004CustomerInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2004CustomerInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:edenai/model/InlineResponse2004CustomerInformation} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2004CustomerInformation} The populated <code>InlineResponse2004CustomerInformation</code> instance.
   */
   ...
   */
  exports.prototype.customerAddress = undefined;
