...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse2003ResultBoundingBoxes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2003ResultBoundingBoxes'));
  } else {
    // Browser globals (root is window)
    if (!root.EdenAiApiDocumentation) {
      root.EdenAiApiDocumentation = {};
    }
    root.EdenAiApiDocumentation.InlineResponse2003Result = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse2003ResultBoundingBoxes);
  }
}(this, function(ApiClient, InlineResponse2003ResultBoundingBoxes) {
  'use strict';

  /**
   * The InlineResponse2003Result model module.
   * @module edenai/model/InlineResponse2003Result
   * @version v1
   */
   ...
   * object
   * @alias module:edenai/model/InlineResponse2003Result
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse2003Result} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2003Result} The populated <code>InlineResponse2003Result</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('bounding_boxes'))
        obj.boundingBoxes = ApiClient.convertToType(data['bounding_boxes'], [InlineResponse2003ResultBoundingBoxes]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:edenai/model/InlineResponse2003ResultBoundingBoxes>} boundingBoxes
   */
  exports.prototype.boundingBoxes = undefined;
