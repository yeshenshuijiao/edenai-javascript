 ...
 * @version v1
 */
export class InlineResponse2003Result {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new InlineResponse2003Result();
 ...
 * @member {String} text
 */
InlineResponse2003Result.prototype.text = undefined;

/**
 * @member {Array.<String>} keywords
 */
InlineResponse2003Result.prototype.keywords = undefined;

/**
 * @member {Array.<Number>} importances
 */
InlineResponse2003Result.prototype.importances = undefined;
