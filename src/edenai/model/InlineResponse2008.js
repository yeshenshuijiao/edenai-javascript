...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse2008Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2008Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.EdenAiApiDocumentation) {
      root.EdenAiApiDocumentation = {};
    }
    root.EdenAiApiDocumentation.InlineResponse2008 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse2008Result1);
  }
}(this, function(ApiClient, InlineResponse2008Result1) {
  'use strict';

  /**
   * The InlineResponse2008 model module.
   * @module edenai/model/InlineResponse2008
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2008</code>.
   * syntax analysis response
   * @alias module:edenai/model/InlineResponse2008
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse2008} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2008} The populated <code>InlineResponse2008</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse2008Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:edenai/model/InlineResponse2008Result1>} result
   */
