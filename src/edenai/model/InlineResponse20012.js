...
import {InlineResponse20012Result} from './InlineResponse20012Result';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse20012Result]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:edenai/model/InlineResponse20012Result>} result
 */
