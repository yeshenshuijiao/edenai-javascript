...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse20014Result'], factory);
    ...
    root.EdenAiApiDocumentation.InlineResponse20014 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse20014Result);
  }
   ...
   * @module edenai/model/InlineResponse20014
   * @version v1
   */
   ...
   * Eden AI Search tool
   * @alias module:edenai/model/InlineResponse20014
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse20014} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse20014} The populated <code>InlineResponse20014</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = InlineResponse20014Result.constructFromObject(data['result'], InlineResponse20014Result);
    }
    return obj;
  }

  /**
   * @member {module:edenai/model/InlineResponse20014Result} result
   */
