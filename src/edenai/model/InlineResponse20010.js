...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse20010Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20010Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.EdenAiApiDocumentation) {
      root.EdenAiApiDocumentation = {};
    }
    root.EdenAiApiDocumentation.InlineResponse20010 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse20010Result1);
  }
}(this, function(ApiClient, InlineResponse20010Result1) {
  'use strict';

  /**
   * The InlineResponse20010 model module.
   * @module edenai/model/InlineResponse20010
   * @version v1
   */
   ...
   * @alias module:edenai/model/InlineResponse20010
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse20010} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse20010} The populated <code>InlineResponse20010</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse20010Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:edenai/model/InlineResponse20010Result1>} result
   */
