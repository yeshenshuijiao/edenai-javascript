...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse2001Result'], factory);
    ...
    root.EdenAiApiDocumentation.InlineResponse2001 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse2001Result);
  }
   ...
   * @module edenai/model/InlineResponse2001
   * @version v1
   */
   ...
   * @alias module:edenai/model/InlineResponse2001
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse2001} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2001} The populated <code>InlineResponse2001</code> instance.
   */
