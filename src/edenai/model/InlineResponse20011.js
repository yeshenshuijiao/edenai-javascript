...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse20011Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20011Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.EdenAiApiDocumentation) {
      root.EdenAiApiDocumentation = {};
    }
    root.EdenAiApiDocumentation.InlineResponse20011 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse20011Result1);
  }
}(this, function(ApiClient, InlineResponse20011Result1) {
  'use strict';

  /**
   * The InlineResponse20011 model module.
   * @module edenai/model/InlineResponse20011
   * @version v1
   */
   ...
   * @alias module:edenai/model/InlineResponse20011
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse20011} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse20011} The populated <code>InlineResponse20011</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse20011Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:edenai/model/InlineResponse20011Result1>} result
   */
