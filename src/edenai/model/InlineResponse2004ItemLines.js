...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EdenAiApiDocumentation.InlineResponse2004ItemLines = factory(root.EdenAiApiDocumentation.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2004ItemLines model module.
   * @module edenai/model/InlineResponse2004ItemLines
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2004ItemLines</code>.
   * @alias module:edenai/model/InlineResponse2004ItemLines
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2004ItemLines</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:edenai/model/InlineResponse2004ItemLines} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2004ItemLines} The populated <code>InlineResponse2004ItemLines</code> instance.
   */
