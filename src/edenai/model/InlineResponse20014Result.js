...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EdenAiApiDocumentation.InlineResponse20014Result = factory(root.EdenAiApiDocumentation.ApiClient);
  }
   ...
   * @module edenai/model/InlineResponse20014Result
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse20014Result</code>.
   * @alias module:edenai/model/InlineResponse20014Result
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse20014Result} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse20014Result} The populated <code>InlineResponse20014Result</code> instance.
   */
  ...
  /**
   * object with attributes < word: True/False > 
