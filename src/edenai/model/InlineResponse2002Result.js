 ...
 * @module edenai/model/InlineResponse2002Result
 * @version v1
 */
export class InlineResponse2002Result {
  /**
   * Constructs a new <code>InlineResponse2002Result</code>.
   * @alias module:edenai/model/InlineResponse2002Result
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:edenai/model/InlineResponse2002Result} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2002Result} The populated <code>InlineResponse2002Result</code> instance.
   */
 ...
 * @member {String} text
 */
InlineResponse2002Result.prototype.text = undefined;

/**
 * @member {Array.<module:edenai/model/InlineResponse2002Results>} results
 */
InlineResponse2002Result.prototype.results = undefined;
