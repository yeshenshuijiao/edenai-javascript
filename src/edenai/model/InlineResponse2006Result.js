...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EdenAiApiDocumentation.InlineResponse2006Result = factory(root.EdenAiApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('classification'))
        obj.classifications = ApiClient.convertToType(data['classification'], Object);
    }
    return obj;
  }
