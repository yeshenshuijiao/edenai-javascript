...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse2006Result1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2006Result1'));
  } else {
    // Browser globals (root is window)
    if (!root.EdenAiApiDocumentation) {
      root.EdenAiApiDocumentation = {};
    }
    root.EdenAiApiDocumentation.InlineResponse2006 = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse2006Result1);
  }
}(this, function(ApiClient, InlineResponse2006Result1) {
  'use strict';

  /**
   * The InlineResponse2006 model module.
   * @module edenai/model/InlineResponse2006
   * @version v1
   */

  /**
   * Constructs a new <code>InlineResponse2006</code>.
   * named entities extraction response
   * @alias module:edenai/model/InlineResponse2006
   * @class
   */
   ...
   * @param {module:edenai/model/InlineResponse2006} obj Optional instance to populate.
   * @return {module:edenai/model/InlineResponse2006} The populated <code>InlineResponse2006</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [InlineResponse2006Result1]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:edenai/model/InlineResponse2006Result1>} result
   */
