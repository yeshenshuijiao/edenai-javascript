...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse20011', 'edenai/model/InlineResponse20012', 'edenai/model/InlineResponse20013'], factory);
    ...
    root.EdenAiApiDocumentation.VisionApi = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse20011, root.EdenAiApiDocumentation.InlineResponse20012, root.EdenAiApiDocumentation.InlineResponse20013);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:edenai/api/VisionApi~explicitContentDetectionCallback
     ...
     * @param {File} files File Image to analyse (ex: pdf, jpg, jpeg, png, tiff)
     * @param {String} providers Provider to compare (ex: [ 'amazon', 'microsoft', 'google'])
     ...
     * data is of type: {@link module:edenai/model/InlineResponse20011}
     */
    this.explicitContentDetection = function(files, providers, callback) {
      var postBody = null;
     ...
     * @callback module:edenai/api/VisionApi~faceDetectionCallback
     * @param {String} error Error message, if any.
     ...
     * data is of type: {@link module:edenai/model/InlineResponse20012}
     */
    this.faceDetection = function(files, providers, callback) {
      var postBody = null;
     ...
     * @callback module:edenai/api/VisionApi~objectDetectionCallback
     * @param {String} error Error message, if any.
     * @param {module:edenai/model/InlineResponse20013} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:edenai/model/InlineResponse20013}
     */
    this.objectDetection = function(files, providers, callback) {
      var postBody = null;
