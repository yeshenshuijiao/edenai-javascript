...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['edenai/ApiClient', 'edenai/model/InlineResponse20014'], factory);
    ...
    root.EdenAiApiDocumentation.EdenAIToolsApi = factory(root.EdenAiApiDocumentation.ApiClient, root.EdenAiApiDocumentation.InlineResponse20014);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:edenai/api/EdenAIToolsApi~searchCallback
     * @param {String} error Error message, if any.
     * @param {module:edenai/model/InlineResponse20014} data The data returned by the service call.
     ...
     * data is of type: {@link module:edenai/model/InlineResponse20014}
     */
    this.search = function(text, words, callback) {
      var postBody = null;
