...
(function(root, factory) {
  ...
  describe('edenai', function() {
    describe('EdenAIToolsApi', function() {
      describe('search', function() {
        it("should call search successfully", function (done) {
          ...
          instance.search(text, words, function (error, data, response) {
            ...
            // probleme de sortie par rapport au retour de l'api
            expect(data).to.be.a(EdenAiApiDocumentation.InlineResponse20014);
            // expect(data.result.function).to.be.a(EdenAiApiDocumentation.InlineResponse20014Result);
            expect(data.result.status).to.be.a("string");
            expect(data.result.executionTime).to.be.a("number");
            expect(data.result.result).to.be.a(Object);
          });
          done();
        });
      });
