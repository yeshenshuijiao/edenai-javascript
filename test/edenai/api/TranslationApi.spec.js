...
(function (root, factory) {
  ...
  beforeEach(function () {
    ...
    instance = new EdenAiApiDocumentation.TranslationApi();
  });

  describe("edenai", function () {
    describe("TranslationApi", function () {
      describe("automaticTranslation", function () {
        it("should call automaticTranslation successfully", function (done) {
          // TODO: uncomment, update parameter values for automaticTranslation call and complete the assertions
          ...
          instance.automaticTranslation(
            ...
            function (error, data, response) {
              ...
              expect(data).to.be.a(EdenAiApiDocumentation.InlineResponse2009);
              {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(
                    EdenAiApiDocumentation.InlineResponse2009Result1
                  );
                  ...
                  expect(data.result).to.be.a(
                    EdenAiApiDocumentation.InlineResponse2009Result
                  );
      ...
      describe("languageDetection", function () {
        it("should call languageDetection successfully", function (done) {
          // TODO: uncomment, update parameter values for languageDetection call and complete the assertions

          var text = "ceci est un texte";
          var providers = "['amazon']";

          instance.languageDetection(
            text,
            providers,
            function (error, data, response) {
              if (error) {
              ...
              // TODO: update response assertions
              expect(data).to.be.a(EdenAiApiDocumentation.InlineResponse20010);
              {
                let dataCtr = data.result;
                expect(dataCtr).to.be.an(Array);
                expect(dataCtr).to.not.be.empty();
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(
                    EdenAiApiDocumentation.InlineResponse20010Result1
                  );
                  expect(data.solutionName).to.be.a("string");
                  expect(data.provider).to.be.a("string");
                  expect(data.status).to.be.a("string");
                  ...
                  expect(data.originalResult).to.be.a(Object);
                  expect(data.result).to.be.a(
                    EdenAiApiDocumentation.InlineResponse20010Result
                  );
